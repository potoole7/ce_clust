...
\section{Motivating example: Irish Meterological Data}
...
\begin{itemize}
  ...
  \item Specifically, we estimated $\chi$ and $\chibar$ at the 95th quantile for each of our 59 sites, to determine the extent of asymptotic dependence between our variables, and whether any spatial patterns in this dependence emerge. 
...
\begin{itemize}
  \item In our analysis, we first transformed the data to Laplace margins, using the ECDF to approximate density functions for rain and wind speed at each location. \todo{reference specific equation in methods}
    ...
    \item The results of this CE analysis are shown in figure \ref{fig:02_locs}.
...
\begin{itemize}
  \item We clustered the locations using the $JS^{G_{\alpha}}$ dissimilarity matrix for their CE parameters, as described in \ref{subsec:clust_js}, for the CE models fit to rain conditional on extreme wind speed and vice versa, separately. 
