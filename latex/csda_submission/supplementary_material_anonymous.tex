...
\externaldocument{manuscript_anonymous}
...
\if0\blind
  ...
  \address{Department of Mathematical Sciences, University of Bath, UK}
  \author{Christian Rohrbeck}
  \address{Department of Mathematical Sciences, University of Bath, UK}
  \author{Jordan Richards}
  \address{School of Mathematics and Maxwell Institute for Mathematical Sciences, University of Edinburgh, UK}
\else 
  \author{}
  \address{}
\fi
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.9\linewidth]{sup_fig_1.png}
    \caption{\emph{ 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.9\linewidth]{sup_fig_2.png}
    \caption{\emph{
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.62\linewidth]{sup_fig_3.png}
    \caption{\emph{
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.62\linewidth]{sup_fig_4.png}
    \caption{\emph{
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.62\linewidth]{sup_fig_5.png}
    \caption{\emph{
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.62\linewidth]{sup_fig_6.png}
    \caption{\emph{
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.62\linewidth]{sup_fig_7.png}
    \caption{\emph{
