...
This prospective distance metric must be sensible and valid in the context of the parameters for the conditional extremes model. 
\todo{Probably requires more work}
...
As in any Bayesian model, a likelihood will need to derived, and suitable priors for $\alpha$ and $\beta$, or $\tanh^{-1}{\alpha}$ and $\tahh^{-1}(\beta)$ or $\logit(\beta)$, as in \citet{Winter2016} and \cite{Richards2023} will need to be specified. \todo{Fix!}
