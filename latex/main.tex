...
\begin{itemize}
  ...
  \item We evaluate our clustering solution using the ARI, and in \ref{subsubsec:boot} ascertain the improvement of parameter estimation post-clustering using a bootstrapping scheme. \todo{Rewrite}
\end{itemize}
